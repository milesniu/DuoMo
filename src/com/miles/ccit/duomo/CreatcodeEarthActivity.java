...
public class CreatcodeEarthActivity extends AbsCreatCodeActivity {
  ...
  public void onClick(View v) {
    ...
    switch (v.getId()) {
      ...
      case R.id.bt_addoption:
        startActivityForResult(new Intent(mContext, CreatOptionActivity.class).putExtra("typecode", CreatOptionActivity.EARTHCODE),
                               CreatOptionActivity.EARTHCODE);
        break;
    }
  }
  ...
  private String composeSendData() {
    String
        data =
        "P1=0000&P2=001&P3=" + skycode.get(sp_Code.getSelectedItemPosition()).get("code").toString() + (edit_name.getText().toString().equals("") ? ""
                                                                                                                                                  : (
                                                                                                            "&P4=" + edit_name.getText().toString()))
        + "&P5=" + skycolor.get(sp_Color.getSelectedItemPosition()).get("code").toString() + "&P6=" + edit_time.getText().toString() + (
