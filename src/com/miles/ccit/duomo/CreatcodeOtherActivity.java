    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case R.id.bt_right:
                ...
                {
                    MyLog.showToast(mContext, "请输入军标编号");
                    return;
                } else if (!(edit_code.getText() + "").equals("") && Integer.parseInt(edit_code.getText().toString()) > 100000)
                {
                    MyLog.showToast(mContext, "军标编号应在0~100000之间");
                    return;
