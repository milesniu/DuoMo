...
public class CreatcodeWaterActivity extends AbsCreatCodeActivity
{
	...
	public void onClick(View v)
	{
		...
		case R.id.bt_addoption:
			startActivityForResult(new Intent(mContext, CreatOptionActivity.class).putExtra("typecode", CreatOptionActivity.WATERCODE), CreatOptionActivity.WATERCODE);
			break;
		}
	}
	...
	{
		String data = "P1=0000&P2=010&P3="+skycode.get(sp_Code.getSelectedItemPosition()).get("code").toString()+(edit_name.getText().toString().equals("")?"":("&P4="+edit_name.getText().toString()))+"&P5="+skycolor.get(sp_Color.getSelectedItemPosition()).get("code").toString()+"&P6="+edit_time.getText().toString()+(options.size()>0?("&P7="+options.size()):"");
		String option = "";
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data)
	{
		...
		if(requestCode == CreatOptionActivity.WATERCODE&&data!=null)
		{
