...
import com.wz.net.impl.OSNetworkSystem;
import com.wz.net.impl.PlainDatagramSocketImpl;

public class UserDatagramSocket extends DatagramSocket {

	PlainDatagramSocketImpl impl;
	public static boolean loaded = false;
	
	public UserDatagramSocket(int port) throws SocketException, UnknownHostException {
		super(!loaded?port:0);
		if (loaded) {
	...
	static {
			try {
		        ...
		        UserDatagramSocket.loaded = true;
			} catch (Throwable e) {
			}
	}
}
