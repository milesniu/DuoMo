package com.redfox.voip_pro.xmlrpc;
...
import com.redfox.voip_pro.de.timroes.axmlrpc.XMLRPCCallback;
import com.redfox.voip_pro.de.timroes.axmlrpc.XMLRPCClient;
import com.redfox.voip_pro.de.timroes.axmlrpc.XMLRPCException;
import com.redfox.voip_pro.de.timroes.axmlrpc.XMLRPCServerException;
    ...
    public XmlRpcHelper(String serverUrl) {
    	try {
			if(serverUrl != null) {
				...
				mXmlRpcClient = new XMLRPCClient(new URL(RedfoxPreferences.instance().getXmlRpcServerUrl()));
			}
