...
public class RedfoxNumberOrAddress implements Serializable {
	/**
	 * 
	 */
	...
	public RedfoxNumberOrAddress(String v, boolean isSIP) {
		value = v;
		isSIPAddress = isSIP;
		oldValueForUpdatePurpose = null;
	}
	
	public RedfoxNumberOrAddress(String v, boolean isSip, String old) {
		this(v, isSip);
